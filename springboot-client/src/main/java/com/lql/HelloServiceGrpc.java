...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.lql.HelloProto.HelloRequest.class,
      responseType = com.lql.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest, com.lql.HelloProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.lql.HelloProto.HelloRequest, com.lql.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lql.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lql.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getC2ssMethod;
  ...
  public static io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getC2ssMethod() {
    io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest, com.lql.HelloProto.HelloResponse> getC2ssMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getCs2sMethod;
  ...
  public static io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getCs2sMethod() {
    io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest, com.lql.HelloProto.HelloResponse> getCs2sMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getCs2ssMethod;
  ...
  public static io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest,
      com.lql.HelloProto.HelloResponse> getCs2ssMethod() {
    io.grpc.MethodDescriptor<com.lql.HelloProto.HelloRequest, com.lql.HelloProto.HelloResponse> getCs2ssMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(com.lql.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHelloMethod(), responseObserver);
    }

    /**
     */
    default void c2ss(com.lql.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloRequest> cs2s(
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloRequest> cs2ss(
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(com.lql.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    public void c2ss(com.lql.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloRequest> cs2s(
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloRequest> cs2ss(
        io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public com.lql.HelloProto.HelloResponse hello(com.lql.HelloProto.HelloRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.lql.HelloProto.HelloResponse> c2ss(
        com.lql.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lql.HelloProto.HelloResponse> hello(
        com.lql.HelloProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.lql.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse>) responseObserver);
          break;
        case METHODID_C2SS:
          serviceImpl.c2ss((com.lql.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.lql.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.lql.HelloProto.HelloRequest,
              com.lql.HelloProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.lql.HelloProto.getDescriptor();
    }
